...
export const Wadaq = {
  ...
  api: {
    InvokeLLM: async (prompt) => {
      ...
      if (prompt.includes("المخزون")) {
        return {
          text: "تنبيه المخزون: هناك 4 منتجات تقترب من النفاد. استراتيجية التوريد الحالية تحتاج لتعديل لتجنب الانقطاع.",
        };
      }
      return {
        text: "أنا جاهز لتحليل بيانات مؤسسة ثروة. كيف يمكنني مساعدتك في اتخاذ قرار مالي اليوم؟",
      };
    },
