...
const highlights = [
  "تجربة مجانية عند التسجيل",
  "تسجيل بالبريد أو Google",
...
const faqs = [
  {
    ...
    a: "نعم. صُمم ليكون بسيطاً للبدء مع قوة كافية للنمو مع منشأتك.",
  },
  {
    q: "كيف أبدأ؟",
    a: "اضغط «ابدأ رحلتك المحاسبية»، أنشئ حساباً بالبريد وكلمة المرور أو عبر Google، ثم ادخل لوحة التحكم.",
  },
  {
    q: "هل أحتاج بطاقة ائتمان؟",
    a: "يمكنك البدء بالتجربة دون التزام؛ تفاصيل الاشتراك تظهر داخل النظام عند الحاجة.",
  },
];
...
export default function Landing() {
  ...
  return (
    <div dir="rtl" className="min-h-screen overflow-x-hidden text-slate-900" style={{ background: "#eef1f6" }}>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            محاسبة ومبيعات ومخزون في منصة واحدة
          </div>
      ...
      {/* أسئلة شائعة */}
      <section className="py-12 px-4 sm:px-6 border-t bg-white/80" style={{ borderColor: "rgba(26,58,92,0.08)" }}>
        <div className="max-w-2xl mx-auto">
          <h2 className="text-xl font-black text-center mb-8" style={{ color: NAVY }}>
            أسئلة سريعة
          </h2>
